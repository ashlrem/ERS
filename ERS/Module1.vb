    ...
    Public Sub SearchStudent_C_ViewStudent_btn()
        ...
        Try
            ...
            If r.Read Then
                ...
                My.Forms.ViewStud_C.GroupBox1.Enabled = True
                pic = ""

                NSO2 = r("NSO").ToString()
                If NSO2 = "" Then
                    My.Forms.ViewStud_C.nso_lbl.BackColor = Color.Red
                Else
                    My.Forms.ViewStud_C.nso_lbl.BackColor = Color.Green
                End If


                baptis = r("Baptismal").ToString()
                If baptis = "" Then
                    My.Forms.ViewStud_C.baptismal_lbl.BackColor = Color.Red
                Else
                    My.Forms.ViewStud_C.baptismal_lbl.BackColor = Color.Green
                End If

                card = r("UploadCard").ToString()
                If card = "" Then
                    My.Forms.ViewStud_C.card_lbl.BackColor = Color.Red
                Else
                    My.Forms.ViewStud_C.card_lbl.BackColor = Color.Green
                End If

                form137 = r("UploadForm137").ToString()
                If form137 = "" Then
                    My.Forms.ViewStud_C.form_lbl.BackColor = Color.Red
                Else
                    My.Forms.ViewStud_C.form_lbl.BackColor = Color.Green
                End If

                goodMoral = r("UploadGoodMoral").ToString()
                If goodMoral = "" Then
                    My.Forms.ViewStud_C.gm_lbl.BackColor = Color.Red
                Else
                    My.Forms.ViewStud_C.gm_lbl.BackColor = Color.Green
                End If
